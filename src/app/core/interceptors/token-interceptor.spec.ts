...
describe('TokenInterceptor', () => {
  ...
  // Fixed: Added comment to satisfy @typescript-eslint/no-empty-function
  const emptyFn = () => {
    /* No-op */
  };
  ...
  // Fixed: Replaced 'any' with 'unknown' or 'Record' to satisfy @typescript-eslint/no-explicit-any
  function mockRequest(url: string, body?: unknown, headers?: Record<string, string | number>) {
