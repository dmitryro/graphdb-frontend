...
export class ViewRuleComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input() ruleData: any;
  ...
  private subscribeToEvents(): void {
    this.eventSubs = this.eventStore.select('nf').subscribe((state: any) => {
      ...
      console.log(`view-rule.component.ts [subscribeEvents] - payload: ${JSON.stringify(payload)}`);
